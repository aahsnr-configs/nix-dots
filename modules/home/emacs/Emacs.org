...
;; Manually define XDG-compliant paths, replacing no-littering.
...
(make-directory no-littering-etc-directory :parents)
(make-directory no-littering-var-directory :parents)
(make-directory no-littering-cache-directory :parents)

;; Configure Emacs core variables to use these paths
...
#+RESULTS:
| consult-preview-at-point-mode | hide-mode-line-mode |
...
(use-package org
  ...
  (org-agenda-files (list (expand-file-name "inbox.org" my/org-directory)
                          ...
                          (expand-file-name "goals.org" my/org-directory)))
