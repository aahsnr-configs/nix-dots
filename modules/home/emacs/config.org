...
(defun ar/set-fonts ()
  ...
  (set-face-attribute 'default nil :font "Cascadia Code" :height 120 :weight 'medium)
  (set-face-attribute 'fixed-pitch nil :font "Cascadia Code" :height 120 :weight 'medium)
  (set-face-attribute 'variable-pitch nil :font "Cascadia Code" :height 120 :weight 'medium)
...
(use-package consult
  ...
  ;; Configure consult-buffer to show file-visiting buffers, recent files, and bookmarks
  ;; File-visiting buffers appear under "Files" headline
  ;; Recent files and bookmarks provide additional navigation options
...
(defun ar/org-font-setup ()
  ...
  (dolist (face '((org-level-1 . 1.2)
                  ...
                  (org-level-7 . 1.02)
                  (org-level-8 . 1)))
    (set-face-attribute (car face) nil :font "Cascadia Code" :weight 'bold :height (cdr face))))
#+end_src
