...
{ ... }:
{
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      "$mainMod, grave, exec, pypr toggle term"  # Toggle terminal scratchpad
      "$mainMod, Y, exec, pypr toggle yazi"      # Toggle yazi file manager
      "$mainMod, T, exec, pypr toggle filemanager" # Toggle thunar
    ];
    ...
    windowrulev2 = [
      ...
      # Workspace Rules - REMOVED conflicting rules for pyprland scratchpads
      # The scratchpad workspace rules are now handled in windowrule section above
    ];
  };
}
